...
\section{Pipeline} \todo{writte the pipeline}
...
\begin{itemize}
    ...
    \item The \texttt{createExperiment} function is the pivotal component in the data processing pipeline, enabling the creation of a \texttt{DatasetExperiment} S4 object that will be used in almost all of the pipeline. This facilitates efficient modularity.
    ...
    \item The \texttt{exportData} function that creates a node to export the data to a specified directory.
\end{itemize}
