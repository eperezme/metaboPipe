...
% \usepackage[colorinlistoftodos, textwidth=65mm, shadow]{todonotes}
    ...
    \idioma{English}
    \credits{15}
    \parcla{targeted metabolomics, pretreatement, pipeline}
