...
list(
  ...
  #### THE SHINY CODE STEPS GOES HERE ####
...
filter_step(filtered_1, factorized, threshold = 0.8, filter_outliers = FALSE, conf.limit = '0.95', out_dir = out_dir),
filter_step(filtered_2, filtered_1, threshold = 0.8, filter_outliers = TRUE, conf.limit = '0.95', out_dir = out_dir),
impute(imputed_3, filtered_2, method = 'kNN', k = 5, out_dir = out_dir),
impute(imputed_4, imputed_3, method = 'SVD', k = 10, out_dir = out_dir),
