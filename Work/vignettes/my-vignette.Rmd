...
# General config
outdir = "results"
dir.create(out_dir, showWarnings = FALSE) # We create the outdir in case there its not created yet
out_dir <- tools::file_path_as_absolute(out_dir) # We get the absolute path of the dir for compatibility
